...
fun String.parseEntity(): CottontailGrpc.EntityName {
    ...
    return when (split.size) {
        ...
        2 -> CottontailGrpc.EntityName.newBuilder().setName(split[0]).setSchema(CottontailGrpc.SchemaName.newBuilder().setName(split[1])).build()
...
fun String.parseColumn(): CottontailGrpc.ColumnName {
    ...
    return when (split.size) {
        ...
        2 -> CottontailGrpc.ColumnName.newBuilder().setName(split[0]).setEntity(CottontailGrpc.EntityName.newBuilder().setName(split[1])).build()
        3 -> CottontailGrpc.ColumnName.newBuilder().setName(split[0]).setEntity(CottontailGrpc.EntityName.newBuilder().setName(split[1]).setSchema(CottontailGrpc.SchemaName.newBuilder().setName(split[2]))).build()
